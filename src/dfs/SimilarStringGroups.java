 ...
 * Two dypro.strings X and Y are similar if we can swap two letters (in different positions) of X, so that it equals Y.
 * Also two dypro.strings X and Y are similar if they are equal. For example, "tars" and "rats" are similar
 ...
 *
 * We are given a list strs of dypro.strings where every string in strs is an anagram of every other string in strs.
